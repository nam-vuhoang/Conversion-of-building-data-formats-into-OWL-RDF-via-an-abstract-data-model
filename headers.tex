...
%
% Check and cross symbols: https://tex.stackexchange.com/questions/202732/checkmark-with-cross
%
\usepackage{pifont}

% tilde symbol: https://tex.stackexchange.com/questions/9363/how-does-one-insert-a-backslash-or-a-tilde-into-latex
\usepackage{textcomp}

\newcommand{\yes}{\ding{51}} % alternative: \ding{52}
\newcommand{\no}{\ding{55}} % alternative: \ding{56}
\newcommand{\yesno}{$\sim$} % alternative: \ding{56}
